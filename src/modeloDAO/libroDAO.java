...
public class libroDAO implements CRUD{
 ConectaBd cn = new ConectaBd();
    ...
    public List listarlibro() {
        ...
        String consulta = " select l.idlibro, l.nombre, a.apellidos 'autorapellidos', a.nombre 'autornombre', e.nombre 'editorialnombre',p.nombre 'paisnombre', l.codigo,l.estado " +
...
"e.ideditorial = l.ideditorial   ";
        try {
            ...
            while (rs.next()) {                
                ...
                libro.setPaisnombre(rs.getString("paisnombre"));
