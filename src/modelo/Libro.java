...
public class Libro {
    ...
    public Libro(int idlibro, String nombre, String codigo, String ISBN, String fecha_publicacion, int stock, double precio_compra, String estado, int idautor, int ideditorial, int idpais, String autorapellidos, String autornombre, String editorialnombre, String paisnombre) {
    ...
    public Libro(int idlibro, String nombre, String codigo, String ISBN, String fecha_publicacion, int stock, double precio_compra, String estado, int idautor, int ideditorial, String autorapellidos, String autornombre, String editorialnombre, String paisnombre) {
        this.idlibro = idlibro;
        this.nombre = nombre;
        this.codigo = codigo;
        this.ISBN = ISBN;
